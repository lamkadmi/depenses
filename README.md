...
Ce repository contient un exemple d'application qui implémente l'architecture MVVM à l'aide de Dagger2, Room, RxJava, FastAndroidNetworking, PlaceHolderView et AndroidDebugDatabase.
