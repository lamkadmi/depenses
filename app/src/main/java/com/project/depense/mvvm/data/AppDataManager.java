...
package com.project.depense.mvvm.data;
...
import com.project.depense.mvvm.data.model.api.BlogResponse;
import com.project.depense.mvvm.data.model.api.LoginRequest;
import com.project.depense.mvvm.data.model.api.LoginResponse;
import com.project.depense.mvvm.data.model.api.LogoutResponse;
import com.project.depense.mvvm.data.model.api.OpenSourceResponse;
...
public class AppDataManager implements DataManager {
    ...
    @Override
    public Single<List<QuestionCardData>> getObjectifsData() {
        return mDbHelper.getAllQuestions()
                .flatMap(questions -> Observable.fromIterable(questions))
                .flatMap(question -> Observable.zip(
                        mDbHelper.getOptionsForQuestionId(question.id),
    ...
    @Override
    public Observable<Boolean> saveRevenu(Revenu revenu) {
        return mDbHelper.saveRevenu(revenu);
    }
